...
#+begin_src shell
  ## Ejercicio para el lector, por favor generar el comando para ejecutar cassandra ustedes
  ##
#+end_src
...
#+begin_src sh
  ...
  VALUES ( 'Miguel','Escalante', 'Mr.','juan@example.com')
  ;
#+end_src
